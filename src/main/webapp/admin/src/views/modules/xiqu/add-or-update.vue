                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xiquPhoto" label="戏曲封面" prop="xiquPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.xiquPhoto?ruleForm.xiquPhoto:''"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xiquVideo" label="戏曲视频" prop="xiquVideo">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.xiquVideo?ruleForm.xiquVideo:''"
                            @change="xiquVideoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiquVideo" label="戏曲视频" prop="xiquVideo">
                            <video :src="ruleForm.xiquVideo" width="100" height="100" controls="controls">
                            </video>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="地区" prop="xiquAddress">
                       <el-input v-model="ruleForm.xiquAddress"
                                 placeholder="地区" clearable  :readonly="ro.xiquAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="地区" prop="xiquAddress">
                           <el-input v-model="ruleForm.xiquAddress"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="戏曲详情" prop="xiquContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiquContent" label="戏曲详情" prop="xiquContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xiquPhoto: [
                              { required: true, message: '戏曲封面不能为空', trigger: 'blur' },
                          ],
                   xiquVideo: [
                   ...
                   xiquContent: [
                              { required: true, message: '戏曲详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
